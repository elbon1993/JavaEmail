...
public class EmailWithInlineImage {
...
//			message.setText("chitti naannalooooooooooo..");
			...
			bodyPart.setContent("<H2>Its Me :)</H2>", "text/html");
			multiPart.addBodyPart(bodyPart);
			
			// Part 2
			bodyPart = new MimeBodyPart();
			bodyPart.setDataHandler(new DataHandler(new FileDataSource("C:\\Users\\Asus\\Desktop\\passphoto.jpg")));
